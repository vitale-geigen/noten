...
violinI = \relative c'' { 
  {
    ...
    \partial 8
    a8 |
    d,( f a-.) d^1( e f-.) e^2 g16^4 ( f e d) cis8( a) e\upbow |
    cis8( e a-.) e'( f g-.) f a16( g f e) d8( a) f\upbow |
    d8_0\downbow( f'16^3\downbow) e d^1 f^3  bes a g f e d  c^2 d e d c e  a g f e d c |
    ...
    f,(^1 g! a) e f a^3  d,(^1 e f) cis^1 d f  gis,8.^1 a16 b c d(^1 e f) d b' d, |
    c(^1 d e) c a' c,  b(^1 c d) b fis' b,  c(^1 d e) c a' c,  d(^1 e f) d b' d, |
    c(^1 d e) b c a  b(^1 c d) a b gis  a a, cis e g8~  g16 e cis a cis e |
    f d f a d cis  d a d f a gis  a e cis a e cis a4 s8 |
    \bar "|."
  }
}
