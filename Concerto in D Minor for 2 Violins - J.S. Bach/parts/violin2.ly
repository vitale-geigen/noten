...
violin_II =  \relative g' {
  {
    ...
    %30
    a8\mf d16\upbow^1 e^2\stemDown f8^3 d,~(\downbow_2\stemNeutral d16 c!_1) b_2 a b8\upbow g'~\downbow | 
    ...
    es f,^1\upbow es'4~^3\downbow es8 f,-.(^1\upbow bes,-.)^1 d'~^2\downbow |
